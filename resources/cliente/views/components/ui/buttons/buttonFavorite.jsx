...
import { addFavorite } from "../../../../services/favorite/serviceFavorite"
import { useNavigate } from "react-router-dom"

export function ButtonFavorite( { id_producto } ) {
  ...
  async function handleClick() {
    ...
    const res = await addFavorite(user.id_usuario, id_producto);
