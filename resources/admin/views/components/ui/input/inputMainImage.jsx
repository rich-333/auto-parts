...
export function InputMainImage({ name, onImageSelect, initialImage }) {
  const [mainImage, setMainImage] = useState(null);
  const [mainImagePreview, setMainImagePreview] = useState(initialImage || null);
      ...
      >
        ...
        {mainImagePreview ? (
          <img
            ...
            className="max-h-32 w-auto object-contain rounded-md mb-2"
          />
        ) : (
